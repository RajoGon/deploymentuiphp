...
<?php include('navbar.php'); ?>
		<div class="container">
			...
			<!-- FORM -->
			<form class="deploymentform" action="/submitdeployment.php">
				<div class="row">
					<div class = "col-sm-4">
				...
				<div class="row">
					...
					<div class = "col-sm-4">
						  ...
						  <input type="text" class="form-control" id="engcode" required>
						</div>
					</div>
				</div>
				<div class="space"></div>
				<div class="checkbox">
				  <label><input type="checkbox" value="" required> I agree to the Terms of Service</label>
				</div>
